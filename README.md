...
```
              ...
              ────────                   ──────                     ──────
FULL    卖OTM Put spread           卖OTM Put spread           买ATM Call
        (赚溢价+方向保护)           (方向好,溢价中等)           (便宜,直接买方向)

FLAT    卖OTM Call spread         卖OTM Call spread           空仓等待
        (方向空+IV贵→收双份)      (溢价一般,收单份)           (没方向+没溢价)
```
